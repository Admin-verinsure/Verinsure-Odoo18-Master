...
class IrBinary(models.AbstractModel):
    ...
    def _find_record_check_access(self, record, access_token, field=None):
        ...
        parent_method = super()._find_record_check_access
        if 'field' in parent_method.__code__.co_varnames:
            return parent_method(record, access_token, field=field)
        else:
            return parent_method(record, access_token)
